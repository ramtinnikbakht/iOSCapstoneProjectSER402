...
class ChangeTicketTableViewController: UITableViewController, ChartViewDelegate {
    ...
    func loadSampleTickets() {
        ...
        let ticket4 = ChangeTicket_Table_Template(id: obj4.getNumber(), priority: "5",startDate: obj4.getPlannedStart(), icon: eyeIcon!, isWatched: false, requestedByGroupBusinessUnit: obj4.getRequestedByGroupBusinessUnit(), requestedByGroupSubBusinessUnit: obj4.getRequestedByGroupSubBusinessUnit(), closureCode: obj4.closureCode, actualEnd: obj4.actualEnd)
